...
(function () {
    ...
    define("Video/generate", "Generate Video", "#345", function () {
        ...
        this.addWidget("combo", "duration", 10, null, { values: [5, 6, 8, 10, 12, 14, 16, 18, 20] });  // LTX-allowed seconds
        this.addWidget("combo", "aspect", "16:9", null, { values: ["16:9", "9:16"] });
        // Attempts (widget 6): generate this many clips from the same prompt (fresh seed each),
        // saved to the output dir; the last flows downstream. step 10 = increments of 1.
        this.addWidget("number", "attempts", 1, null, { min: 1, max: 10, step: 10, precision: 0 });
